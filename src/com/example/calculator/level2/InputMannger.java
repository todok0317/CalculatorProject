...
public class InputMannger {
    ...
    // 기능
    public int positiveInteger1() {
        int x;
        while(true) {
            try {
                System.out.println("0을 포함한 양의 정수 두 개를 입력합니다.");
    ...
    public int positiveInteger2() {
        int y;
        while(true) {
            try {
                System.out.print("두 번째 정수를 입력하세요. : ");
                y = scanner.nextInt(); // 3 + 엔터 ->입력
    ...
    public void removeFirstIdxFromResultPrice(List<Integer> resultPrice) {
        String removeAnswer;
